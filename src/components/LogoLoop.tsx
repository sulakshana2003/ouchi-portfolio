...
const toCssLength = (value: number | string | undefined | null) =>
  typeof value === "number" ? `${value}px` : (value ?? undefined);
...
const useResizeObserver = (
  ...
  useEffect(() => {
    ...
    // NOTE: elements refs are stable; callback is memoized by caller
...
export const LogoLoop = memo(function LogoLoop({
  ...
  useResizeObserver(updateDimensions, [containerRef, seqRef] as any, [
    logos,
    gap,
    logoHeight,
    isVertical,
  ]);
  useImageLoader(seqRef as any, updateDimensions, [
    logos,
    gap,
    logoHeight,
    isVertical,
